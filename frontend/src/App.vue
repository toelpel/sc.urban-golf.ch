<template>
  <div class="min-h-screen bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-white">
    <nav class="bg-white dark:bg-gray-800 border-b p-4 shadow-sm relative z-50">
      <div class="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div class="md:hidden relative" ref="menuWrapper">
          ...
          <transition name="fade-slide">
            <div
              v-if="isOpen"
              class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 border rounded shadow z-50 text-sm"
            >
              <router-link
                to="/new-game"
