<template>
    ...
    <div class="hidden md:flex items-center gap-3">
        ...
        <router-link to="/roadmap" class="material-nav-link"
            :class="{ 'material-nav-link--active': $route.path === '/roadmap' }">
            🧭 {{ $t('General.Roadmap') }}
        </router-link>
        ...
        <div ref="menuWrapper" class="relative">
            ...
            <transition name="fade-slide">
                <div v-if="isOpen"
                    ...
                    <router-link to="/roadmap" class="dropdown-item"
                        :class="{ 'dropdown-item--active': $route.path === '/roadmap' }" @click="isOpen = false">
                        🧭 {{ $t('General.Roadmap') }}
                    </router-link>
